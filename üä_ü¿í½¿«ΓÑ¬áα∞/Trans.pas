...
begin
EditPrets.DBEdit1.Text:=Data.TOuvrages.FieldByName('N_CARTE').Text;
EditPrets.DBEdit2.Text:=Data.TOuvrages.FieldByName('NOM').Text;
EditPrets.DBEdit3.Text:=Data.TOuvrages.FieldByName('PRENOM').Text;
TransPrets.Hide;
